    ...
    <main className={styles.main}>
      ...
      <div className={styles.client__page}>
        ...
        <div className={styles.client__content__container}>
            <p className={styles.client__title} style={{color: 'gray', marginBottom: '-1rem'}}>CAMPAÑA</p>
            <p className={styles.client__title}>2023</p>
            <div className={styles.client__imagetext}>
              <Paragraph value={'UNA MARCA IDEADA PARA CONECTAR CON TU CRISTO INTERNO'} className={styles.client__metrics_container_title} />
              <Image
