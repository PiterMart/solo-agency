...
export default function Clients() {
  ...
  const brands = [
    ...
    { name: 'Pimux', imageLocation: '/logos/pimuxLogo.png', category: 'Lifestyle', route: '/clients/aia' },
    ...
    { name: 'Timeless', imageLocation: '/logos/timelessLogo.png', category: 'Health & beauty', route: '/clients/aia' },
