...
export default function Clients() {
  ...
  const brands = [
    ...
    { name: 'Lagouarde', imageLocation: '/logos/lagouardeLogo.png', category: 'Lifestyle', route: '/clients/lagouardePropiedades' },
    { name: 'Faitful', imageLocation: '/logos/faitfulLogo.png', category: 'Lifestyle', route: '/clients/faitful' },
    ...
    { name: 'Lagouarde Catering', imageLocation: '/logos/lagouardeLogo.png', category: 'Food & other pleasures', route: '/clients/lagouardeCatering' },
    ...
    { name: 'JP Peluquerias', imageLocation: '/logos/jpLogo.png', category: 'Health & beauty', route: '/clients/jp' },
    { name: 'Eucerin', imageLocation: '/logos/eucerinLogo.png', category: 'Health & beauty', route: '/clients/eucerin' },
    { name: 'Sassone', imageLocation: '/logos/sassoneLogo.png', category: 'Lifestyle', route: '/clients/sassone' },
  ];
